...
import AuthorFantasy from "../components/AuthorFantasy";
import AuthorKrimi from "../components/AuthorKrimi";
import AuthorLove from "../components/AuthorLove";
...
const config = {
  ...
  initialMessages: [
    createChatBotMessage(
      `Hallo, ich bin ${botName}, dein Empfehlungssystem. Ich würde dir gerne bei deiner Suche behilflich sein.`
    ),
    createChatBotMessage(
      `Soll ich dir ein Buch empfehlen? Tippe deine Antwort ein oder klicke auf den entsprechenden Button.`,
      {
        widget: "help"
      }
    )
  ...
  widgets: [
    ...
    {
      widgetName: "authorFantasy",
      widgetFunc: (props) => <AuthorFantasy {...props} />
    },
    {
    ...
    {
      widgetName: "authorLove",
      widgetFunc: (props) => <AuthorLove {...props} />
    },
    {
